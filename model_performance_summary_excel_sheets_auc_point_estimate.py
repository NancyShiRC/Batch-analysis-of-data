...
安装依赖：
pip install pandas numpy scikit-learn lifelines openpyxl
...
示例1：只输出某一个模型/sheet的 performance_summary
python model_performance_summary_excel_sheets_auc_ci_only.py \
  --input_excel "./finaldata/model_predictions.xlsx" \
  --model_sheet "UNI_HE_Ki67" \
  --output_path "./summary/UNI_HE_Ki67_performance_summary.csv"

示例2：输出所有 sheet/模型的 performance_summary
python model_performance_summary_excel_sheets_auc_ci_only.py \
  --input_excel "./finaldata/model_predictions.xlsx" \
  --model_sheet all \
...
python model_performance_summary_excel_sheets_auc_ci_only.py \
    ...
    --group_col group \
    --threshold 0.5 \
    --output_path "UNI_HE_Ki67.csv"

python model_performance_summary_excel_sheets_auc_ci_only.py --input_excel "模型预测原始结果.xlsx" --model_sheet "uniHEIHC" --id_col SampleID --label_col true_label --score_col label_1 --group_col group --threshold 0.5 --output_path "UNI_HE_Ki67.csv"
